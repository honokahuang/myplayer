    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isServiceRunning(MainHomeActivity.this,"com.honoka.player.Service.PlayService")){
                    Intent intent = new Intent(MainHomeActivity.this,PlayService.class);
                    intent.putExtra("MSG", AppConstant.PlayerMsg.GET_INFO);
                    startService(intent);
                }else {
                    Toast.makeText(MainHomeActivity.this,"暂时没有正在播放的音乐\n请选择需要播放的歌曲",Toast.LENGTH_SHORT).show();
                }
            }
        });
